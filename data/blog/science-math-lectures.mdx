...
- The conjugate of $$e^{it}$$ is $$e^{-it}$$
- $$|e^{it}| = 1$$ for all real numbers $$t$$

## Real and Imaginary Parts

- If $$z = a + bi$$, $$a$$ is the real part and $$b$$ is the imaginary part
- The real part of $$e^{it}$$ is $$\cos(t)$$
- The imaginary part of $$e^{it}$$ is $$\sin(t)$$
- Since $$|e^{it}| = 1$$, we get $$\cos^2(t) + \sin^2(t) = 1$$
...
- $$e^{it}$$ traces the unit circle starting at $$e^{i0} = 1$$
- When $$t = \pi$$, $$e^{i\pi} = -1$$
- When $$t = 2\pi$$, $$e^{i2\pi} = 1$$
- In general, $$e^{i2n\pi} = 1$$ for any integer $$n$$
- This gives us the famous identity: $$e^{i\pi} + 1 = 0$$
...
- **Domain Considerations**:
  - Some related functions are restricted to $$\left[-\frac{\pi}{2}, \frac{\pi}{2}\right]$$
